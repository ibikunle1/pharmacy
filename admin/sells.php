...
if (isset($_GET['staff'])){
	$staff = ($_GET['staff']);
	$select = "SELECT * FROM user WHERE id = '$staff'";
...
if (!(isset ($_SESSION["email"]))) {
    ...
    $verify = "SELECT * FROM sells WHERE name = '$name' ";
    ...
    <div class="site-wrap">
        ...
        <table class="table table-bordered table-hover table-striped">
			...
			while ($data = mysqli_fetch_array($check)){ 
				$id = $data['id'];
				echo "<tr><td>" .++$y. "</td><td>" . $data['name'] . "</td><td>" . $data['item_name'] . "</td><td>" . $data['quantity'] . "</td><td>" . $data['date'] . "</td><td>" . $data['time'] . "</td><tr>";
				}
			?>
