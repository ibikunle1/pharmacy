...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="bg-light py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Products</strong></div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php while ($get=mysqli_fetch_array($search_result)){
                        ...
                        $price = $get['price'];
                        $image = $get['image'];
                        echo "<a href='login.php?item=$id'><img src = $image height ='400px' alt='$name'>";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <a href="about.html"><button type="button" class="btn btn-secondary">More</button></a>
                    </div>
